...
export default function OtherRegistrationPage() {
  ...
  const fetchOtherRegistrationForms = useCallback(async () => {
    ...
    try {
      ...
      // Send service filter to backend (Registration)
      params.append('service', 'Registration');
      ...
      // PartnershipForm has service: "Registration" (or legacy "Other Registration") and subService: "partnership-firm"
      let otherRegistrationForms = response.data.forms.filter((form: any) => {
        ...
        // Show PartnershipForm forms that belong to Registration service
        if (form.formType === 'PartnershipForm') {
          return (form.service === 'Other Registration' || form.service === 'Registration') || form.subService === 'partnership-firm' || form.subService === 'Partnership Firm';
        }
        return false;
      });
    ...
    <div className="container mx-auto p-6">
      ...
      >
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-white">Registration Forms</h1>
                    ...
                    <TableRow key={form._id}>
                      ...
                      <TableCell>
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => router.push(`/admin/forms/registration/${form._id}`)}
                        >
