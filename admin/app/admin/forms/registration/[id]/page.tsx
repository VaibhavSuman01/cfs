...
export default function OtherRegistrationDetailPage() {
  ...
  const fetchFormDetails = async () => {
    try {
      ...
      if (targetForm) {
        ...
        router.push('/admin/forms/registration')
      }
    } catch (error) {
  ...
  const handleSendReport = async () => {
    ...
    try {
      ...
      formData.append('reportType', 'Registration Report');
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/admin/forms/registration')} className="mt-4">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              onClick={() => router.push('/admin/forms/registration')}
            >
              <ArrowLeft className="mr-2 h-4 w-4" />
              Back
            </Button>
