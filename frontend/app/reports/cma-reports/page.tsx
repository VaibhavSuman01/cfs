    ...
    <div className="min-h-screen bg-white">
            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Credit Monitoring Arrangement reports for loan applications and financial analysis. Our expert CMA reports help businesses secure loans and demonstrate financial credibility to banks and financial institutions.
                </p>

                <div className="grid sm:grid-cols-3 gap-4 pt-6">
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    <div className="text-2xl font-bold text-blue-600">
                      <PricingDisplay serviceName="dscr/cma report" />
                    </div>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link href={`/dashboard/reports?service=${encodeURIComponent('CMA Reports')}`} passHref>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">What is a CMA Report?</h2>
              <p className="text-lg text-gray-600">
                A comprehensive financial analysis document required by banks for loan applications
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">Detailed analysis of company's financial performance and projections.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <Shield className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Credit Assessment</h3>
                <p className="text-gray-600">Critical document for banks to assess business creditworthiness.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <Calculator className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Loan Requirement</h3>
                <p className="text-gray-600">Essential for securing loans and working capital from banks.</p>
              </Card>
            </div>
          </div>
        </section>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">CMA Report Process</h2>
              <p className="text-lg text-gray-600">
                Our systematic approach to creating comprehensive CMA reports
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">Gather financial statements, bank statements, and business details.</p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">Analyze profitability, liquidity, and financial ratios.</p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-xl font-semibold">Projection Creation</h3>
                  <p className="text-gray-600">Create financial projections and cash flow statements.</p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-xl font-semibold">Report Finalization</h3>
                  <p className="text-gray-600">Compile comprehensive CMA report with recommendations.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold">Need a CMA Report?</h2>
              <p className="text-xl text-blue-100 leading-relaxed">
                Secure your business loan with a professionally prepared CMA report. Our experts will analyze your financials and create a bank-ready document that demonstrates your creditworthiness.
              </p>
