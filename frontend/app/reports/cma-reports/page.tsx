            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Credit Monitoring Arrangement reports for loan applications
                  and financial analysis. Our expert CMA reports help businesses
                  secure loans and demonstrate financial credibility to banks
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                A comprehensive financial analysis document required by banks
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Detailed analysis of company's financial performance and
                  projections.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Critical document for banks to assess business
                  creditworthiness.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Essential for securing loans and working capital from banks.
                </p>
              </Card>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Gather financial statements, bank statements, and business
                    details.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Analyze profitability, liquidity, and financial ratios.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    Create financial projections and cash flow statements.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    Compile comprehensive CMA report with recommendations.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Secure your business loan with a professionally prepared CMA
                report. Our experts will analyze your financials and create a
                bank-ready document that demonstrates your creditworthiness.
              </p>
