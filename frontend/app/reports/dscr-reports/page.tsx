            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Assess your debt service coverage ratio to evaluate your
                  ability to repay loans. Our DSCR reports help lenders
                  understand your financial capacity and improve your loan
                  approval chances.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Debt Service Coverage Ratio measures your ability to repay debt
                obligations
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Measures available cash flow to cover debt payments.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Critical metric for lenders to evaluate loan applications.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Helps assess the risk level of lending to your business.
                </p>
              </Card>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Collect income statements, cash flow statements, and debt
                    details.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Calculate debt service coverage ratio using industry
                    standards.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Analyze the ratio and provide actionable insights.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    Deliver comprehensive DSCR report with recommendations.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Demonstrate your debt repayment capacity to lenders with a
                professionally prepared DSCR report. Our experts will analyze
                your financials and create a comprehensive report that improves
