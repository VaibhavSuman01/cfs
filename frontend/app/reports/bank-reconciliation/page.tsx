            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Ensure your financial records are accurate and consistent with
                  your bank statements. Our expert reconciliation services help
                  identify discrepancies and maintain financial integrity.
                </p>

                <div className="grid sm:grid-cols-3 gap-4 pt-6">
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    <div className="text-2xl font-bold text-blue-600">
                      <PricingDisplay serviceName="bank reconciliation" />
                    </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                A systematic process to ensure your accounting records match
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Compare your book balance with bank statement balance to
              ...
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Identify and correct errors in both your records and bank
                  statements.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Maintain accurate financial records and prevent fraud or
                  discrepancies.
                </p>
              </Card>
            </div>
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Gather bank statements and your accounting records for the
                    period.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Match each transaction in your books with the bank
                    statement.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Identify and investigate any differences or missing
                    transactions.
                  </p>
                </div>
                <div className="text-center space-y-4">
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Ensure your financial records are accurate and compliant. Our
                expert team will help you maintain financial integrity through
