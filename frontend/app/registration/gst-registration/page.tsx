            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Goods and Services Tax (GST) is an indirect tax used in India
                  on the supply of goods and services. GST Filing is mandatory
                  for businesses whose turnover exceeds the prescribed threshold
                  limit. It helps in consolidating multiple indirect taxes into
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Mandatory registration for businesses above threshold limit.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Unified tax structure replacing multiple indirect taxes.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Essential for legal business operations and tax compliance.
                </p>
              </Card>
            </div>
          </div>
                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-3 text-left">
                    <li className="flex items-center">
                      ...
                      <span>GST Registration Application</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                      <span>Basic Documentation Support</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Submit GST registration application with business details.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    GST registration and certificate issuance.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Ensure your business operates legally and efficiently with GST
                registration. Get started today and streamline your tax
                compliance process.
              </p>
