            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  A Digital Signature Certificate (DSC) is the electronic
                  equivalent of physical or paper certificates. DSCs serve as a
                  digital identity for an individual or organization to prove
                  their identity, access information or services on the
                  Internet, and sign certain documents digitally.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                The electronic equivalent of physical or paper certificates for
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Prove your identity and authenticate documents digitally with
                  high security.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Legally recognized for e-filing, online transactions, and
                  document signing.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Access government services and conduct business online from
                  anywhere.
                </p>
              </Card>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Our streamlined process to get your Digital Signature
                Certificate
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Submit DSC application with required documents.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Digital certificate generation and encryption.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    Secure delivery of your DSC certificate.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Secure your online presence and unlock the convenience of
                digital transactions. Get your Digital Signature Certificate
                today and step into the future of secure business.
              </p>
