            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  An Industrial License is a permit required for setting up and
                  operating an industrial undertaking in India. It ensures that
                  industries comply with environmental, safety, and zoning
                  regulations, promoting organized and sustainable industrial
                  development.
                </p>
                ...
                <div className="grid sm:grid-cols-3 gap-4 pt-6">
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    <div className="text-2xl font-bold text-blue-600">
                      <PricingDisplay serviceName="industry license" />
                    </div>
            ...
            <FadeInSection className="hidden lg:block">
              <div className="relative">
                ...
                <div className="relative rounded-lg w-full h-80 flex items-center justify-center">
                  <Factory className="h-32 w-32 text-blue-600" />
                </div>
              </div>
            </FadeInSection>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">
                What is Industry License?
              </h2>
              <p className="text-lg text-gray-600">
                A permit required for setting up and operating industrial
                undertakings
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <Factory className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">
                  Industrial Operations
                </h3>
                <p className="text-gray-600">
                  Required for setting up and operating industrial units.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Submit industry license application with project details.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Government approval and compliance verification.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    Industry license issuance and delivery.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold">
                Ready to Start Your Industry?
              </h2>
              <p className="text-xl text-blue-100 leading-relaxed">
                Ensure your industrial unit operates legally and safely with
                proper licensing. Get your industry license today and comply
