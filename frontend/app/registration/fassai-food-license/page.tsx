            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  ...
                  Family Welfare. An FSSAI license is mandatory for any food
                  business operator in India, ensuring the food products undergo
                  quality checks and are safe for consumption.
                </p>

                <div className="grid sm:grid-cols-3 gap-4 pt-6">
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    <div className="text-2xl font-bold text-blue-600">
                      <PricingDisplay serviceName="fassai food license" />
                    </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                The Food Safety and Standards Authority of India for food
                business regulation
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Ensures food products meet quality and safety standards.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Mandatory licensing for all food business operators.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Protects consumers from unsafe food products.
                </p>
              </Card>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Submit FSSAI application with business details.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Food safety inspection and compliance check.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    FSSAI license issuance and delivery.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Ensure compliance with food safety standards and build consumer
                trust. Get your FSSAI food license today and operate your food
                business legally and safely.
              </p>
