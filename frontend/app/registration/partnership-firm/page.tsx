            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Start your business with two or more partners. A Partnership
                  Firm is easy to form with minimal compliance, making it a
                  popular choice for small and medium-sized businesses.
                </p>

                <div className="grid sm:grid-cols-3 gap-4 pt-6">
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    <div className="text-2xl font-bold text-blue-600">
                      <PricingDisplay serviceName="partnership firm" />
                    </div>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link
                    href={`/dashboard/registration?service=${encodeURIComponent(
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                ...
                terms and objectives set out in a Partnership Deed. It's one of
                the most common business structures in India due to its ease of
                formation.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  A business entity formed by two or more people who agree to
              ...
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  The rights, duties, and profit/loss sharing ratios are
                  governed by a legal agreement called a Partnership Deed.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Simple to start with minimal regulatory compliance compared to
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-3 text-left">
                    <li className="flex items-center">
                      ...
                      <span>Partnership Deed Drafting</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
              ...
              <Card className="border-2 border-blue-400 hover:border-blue-600 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link
                    href={`/contact?service=${encodeURIComponent(
                      "Partnership Firm Registration - Standard"
                    )}`}
                    passHref
                  >
                    <Button className="w-full bg-blue-600 hover:bg-blue-700">
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link
                    href={`/contact?service=${encodeURIComponent(
                      "Partnership Firm Registration - Premium"
                    )}`}
                    passHref
                  >
                    <Button className="w-full bg-blue-600 hover:bg-blue-700">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                While registration is not mandatory, it is highly recommended to
                avail legal benefits. Our process is simple and straightforward.
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    We draft a comprehensive Partnership Deed based on your
                    requirements, covering all essential clauses.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    The deed is printed on stamp paper and signed by all
                    partners in the presence of witnesses.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    We file the application and signed deed with the Registrar
                    of Firms to get your Certificate of Registration.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>PAN Card of all partners.</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>
              ...
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>Certified true copy of the Partnership Deed.</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>
                      Proof of principal place of business (Sale deed or rental
                      agreement).
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>Latest utility bill for the office address.</span>
                  </li>
                </ul>
              </Card>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Team up for success. Let us help you form your Partnership Firm
                quickly and efficiently, setting a strong foundation for your
                business.
              </p>
