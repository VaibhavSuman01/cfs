        ...
        <div className="container mx-auto px-4">
          <FadeInSection className="text-center space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose from various business structures including LLP, Partnership
              Firm, Sole Proprietorship, and more based on your business needs.
            </p>
          </FadeInSection>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  description:
                    "Comply with the Goods and Services Tax law in India.",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Traditional partnership structure for businesses with multiple partners",
                  features: [
                    "Minimum 2 partners required",
                ...
                },
                {
                  ...
                  description:
                    "Simplest form of business ownership for individual entrepreneurs",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Secure your online transactions with a Digital Signature Certificate (DSC).",
                  features: [
                    "Class 3 DSC",
                    "With USB Token",
                    "2 Years Validity",
...

                {
                  ...
                  description:
                    "A mandatory registration for all shops and commercial establishments.",
                  features: [
                ...
                },
                {
                  ...
                  slug: "epfo",
                  description:
                    "Secure your employees' future with provident fund benefits.",
                  features: [
                ...
                },
                {
                  ...
                  slug: "esic",
                  description:
                    "Provide employees with health and social security benefits.",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Ensure your food business complies with food safety standards in India.",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Unlock global markets with your Import Export Code.",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Obtain the necessary licenses to operate your industrial unit legally.",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Get your business recognized as a Micro, Small, or Medium Enterprise.",
                  features: [
                ...
                <FadeInSection key={index} delay={index * 100}>
                  <Card className={getServiceCardClasses("Registration")}>
                    <CardHeader className="text-center">
                      <div
                        className={getServiceBackgroundColor(
                          "Registration"
                        )}
                      >
                        <registration.icon
                          className={getServiceIconColor("Registration")}
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        <div
                          className={getServicePriceColor("Registration")}
                        >
                          {registration.priceKey ? (
                            <PricingDisplay
                              serviceName={registration.priceKey}
                            />
                          ) : (
                            registration.price
                          )}
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Link
                        href={`/registration/${registration.slug}`}
                        passHref
                      >
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                Our experts can help you choose the right business structure
