            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Combine the benefits of a partnership and a company with an
                  LLP. Enjoy limited liability protection and operational
                  flexibility. Get your LLP registered with our expert
                  assistance.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                An LLP is a corporate business vehicle that enables professional
                expertise and entrepreneurial initiative to combine and operate
                in a flexible, innovative, and efficient manner, providing
                benefits of limited liability while allowing its members the
                flexibility for organizing their internal structure as a
                partnership.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Partners are not liable for each other's misconduct or
                  negligence. Liability is limited to their agreed contribution.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  The rights and duties of partners are governed by the LLP
                  agreement, offering great flexibility in management and
                  operations.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  An LLP is a separate legal entity from its partners, having
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                We've simplified the LLP registration process to get you up and
                running in no time.
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-5 gap-8 relative">
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                    <div className="w-16 h-16 mx-auto bg-blue-500 text-white rounded-full flex items-center justify-center text-xl font-bold">
                      1
                    </div>
                  </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Please provide the following documents for a smooth and quick
                registration.
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Find answers to common questions about Limited Liability
                Partnerships.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Get the perfect blend of flexibility and protection for your
                business. Start your LLP registration with our expert team
                today.
              </p>
