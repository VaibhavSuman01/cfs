        ...
        <div className="container mx-auto px-4">
          <FadeInSection className="text-center space-y-8">
            ...
            <div className="flex justify-center space-x-4">
              <Link href={`/contact?service=${encodeURIComponent("Advisory")}&subService=${encodeURIComponent("Other Finance Related Services")}`} passHref>
                ...
                <Card className="border-2 border-blue-200">
                  <CardHeader className="text-center">
                    ...
                    <div className="text-3xl font-bold text-blue-600">
                      <PricingDisplay serviceName="other finance related services" />
                    </div>
