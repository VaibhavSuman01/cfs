    ...
    <div className="min-h-screen bg-white">
            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Simplify your payroll tax obligations, from TDS and PF to ESI. Our comprehensive service ensures accuracy, timeliness, and full statutory compliance for your business.
                </p>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">Our Payroll Tax Services</h2>
              <p className="text-lg text-gray-600">
                We offer a complete suite of services to manage your payroll compliance effectively.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">Accurate calculation and deduction of Tax Deducted at Source (TDS) for all employees and timely filing of returns.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <ShieldCheck className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">PF & ESI Compliance</h3>
                <p className="text-gray-600">Managing Provident Fund (PF) and Employee State Insurance (ESI) contributions, deposits, and return filings.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <FileCheck className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Form 16 Issuance</h3>
                <p className="text-gray-600">Timely generation and issuance of Form 16 to all your employees at the end of the financial year.</p>
              </Card>
            </div>
          </div>
        </section>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">Choose Your Payroll Package</h2>
              <p className="text-lg text-gray-600">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="text-4xl font-bold text-gray-900">₹3,999</div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold">Focus on Your Team, Not on Paperwork</h2>
              <p className="text-xl text-blue-100 leading-relaxed">
                Delegate your payroll tax complexities to us. We ensure your payroll is accurate, compliant, and hassle-free, giving you more time to focus on your people and your business.
              </p>
