            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Stay compliant with the Companies Act by filing your annual
                  returns and financial statements with the Registrar of
                  Companies (ROC) on time, every time.
                </p>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-6">
                  <Link
                    href={`/dashboard/roc-returns?service=${encodeURIComponent(
                      "Annual Filing"
                    )}`}
                    passHref
                  >
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">
                Core Annual Filing Forms
              </h2>
              <p className="text-lg text-gray-600">
                Two primary forms constitute the mandatory annual ROC filing for
                every private limited company in India.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <Card className="p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600">
                    This form contains the company's financial statements,
                    including the Balance Sheet, Profit & Loss Account, and the
                    Director's Report. It must be filed within 30 days of the
              ...
              <Card className="p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600">
                    This form details the company's shareholders, directors, and
                    shareholding structure. It must be filed within 60 days of
                    the AGM. For OPCs, Form MGT-7A is applicable.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">
                Choose Your Annual Filing Package
              </h2>
              <p className="text-lg text-gray-600">
                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-3 text-left">
                    <li className="flex items-center">
                      ...
                      <span>AOC-4 Filing</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                      <span>MGT-7 Filing</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                  ...
                  <Link
                    href={`/dashboard/roc-returns?service=${encodeURIComponent(
                      "Annual Filing"
                    )}&sub?service=${encodeURIComponent("Annual Filing")}`}
                    passHref
                  >
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-3 text-left">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                      <span>Board Meeting Support</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                      <span>1 Year Compliance Support</span>
                    </li>
                  </ul>
                  <Link
                    href={`/dashboard/roc-returns?service=${encodeURIComponent(
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Timely annual filing is crucial for maintaining your company's
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Avoid penalties and legal action from the ROC, ensuring your
              ...
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  A clean compliance record enhances trust with investors,
                  lenders, and customers, showcasing corporate responsibility.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Late or non-filing attracts significant daily penalties and
                  can lead to the disqualification of directors.
                </p>
              </Card>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {[
                {
                  question:
                    "What is the due date for an Annual General Meeting (AGM)?",
                  answer:
                ...
                {
                  question:
                    "Is annual filing mandatory for a dormant or non-operating company?",
                  answer:
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold">
                Secure Your Company's Compliance
              </h2>
              <p className="text-xl text-blue-100 leading-relaxed">
                Don't let deadlines and complex forms overwhelm you. Our experts
                ensure your ROC annual filings are accurate, complete, and
                submitted on time.
              </p>
