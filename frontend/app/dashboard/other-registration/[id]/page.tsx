...
export default function OtherRegistrationDetailPage() {
  ...
  const [form, setForm] = useState<ORDetail | null>(null);
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Other Registration - Details</h1>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <div><span className="font-medium">Service:</span> {form.service || "Other Registration"}</div>
            ...
            <div className="pt-2">
              <Button size="sm" onClick={() => router.push(`/dashboard/other-registration/${form._id}/edit`)}>Edit Form</Button>
            </div>
          </CardContent>
        </Card>
