    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">
          {registrationType ? registrationTypeNames[registrationType] || (serviceParam || "Registration") : (serviceParam || "Registration")}
        </h1>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {registrationType ? registrationTypeNames[registrationType] || (serviceParam || "Registration") : (serviceParam || "Registration")} Form
          </CardTitle>
          <CardDescription>
