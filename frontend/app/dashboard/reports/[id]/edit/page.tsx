...
import { Loader2, ArrowLeft, Upload, FileText, Edit3, Save, AlertCircle, BarChart3 } from "lucide-react";
...
export default function ReportsEditPage() {
  ...
  const onSubmit = async (values: Values) => {
    try {
      ...
      await api.put(API_PATHS.FORMS.REPORTS_UPDATE(id), formData);
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Update your report request details and upload additional documents</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            You can update your report request details and upload additional documents. Existing documents cannot be deleted.
          </AlertDescription>
        </Alert>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
            ...
            <CardDescription>Modify your report request information and add supporting documents</CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                {/* Report Information */}
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Report Information</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField control={form.control} name="reportType" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} className="h-11" placeholder="Enter report type" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  ...
                  <FormField control={form.control} name="description" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea {...field} rows={4} className="resize-none" placeholder="Describe your report request in detail" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
