...
import { Loader2, ArrowLeft, Upload, FileText, AlertCircle, Edit3, Save } from "lucide-react";
...
export default function TrademarkISOEditPage() {
    ...
    const load = async () => {
      ...
      try {
        ...
        form.reset({
          ...
          trademarkClass: data.trademarkClass || "",
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Update your trademark and ISO application details and upload additional documents</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            You can update your trademark and ISO application details and upload additional documents. Existing documents cannot be deleted.
          </AlertDescription>
        </Alert>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
            <CardTitle className="flex items-center gap-2 text-xl">
              ...
              Update Trademark & ISO Details
            </CardTitle>
            <CardDescription>Modify your trademark and ISO application information and add supporting documents</CardDescription>
          </CardHeader>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField control={form.control} name="trademarkName" render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium text-gray-700">Trademark Name *</FormLabel>
                        <FormControl>
                          <Input {...field} className="h-11" placeholder="Enter trademark name" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="trademarkClass" render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium text-gray-700">Trademark Class *</FormLabel>
                        <FormControl>
                          <Input {...field} className="h-11" placeholder="Enter trademark class" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  ...
                  <FormField control={form.control} name="applicantName" render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium text-gray-700">Applicant Name *</FormLabel>
                      <FormControl>
                        <Input {...field} className="h-11" placeholder="Enter applicant name" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  <FormField control={form.control} name="description" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea {...field} rows={4} className="resize-none" placeholder="Describe your trademark and ISO application" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
