      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Update your ROC returns filing details and upload additional documents</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            You can update your ROC returns details and upload additional documents. Existing documents cannot be deleted.
          </AlertDescription>
        </Alert>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
            <CardTitle className="flex items-center gap-2 text-xl">
              ...
              Update ROC Returns Details
            </CardTitle>
            <CardDescription>Modify your ROC returns filing information and add supporting documents</CardDescription>
          </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField control={form.control} name="companyName" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} className="h-11" placeholder="Enter company name" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="remarks" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea {...field} rows={3} className="resize-none" placeholder="Add any additional remarks" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
