            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  ...
                  that an organization can follow, rather than establishing
                  environmental performance requirements. Certification helps
                  organizations improve their environmental performance through
            ...
            <FadeInSection className="hidden lg:block">
              <div className="relative">
                ...
                <div className="relative rounded-lg w-full h-80 flex items-center justify-center">
                  <Leaf className="h-32 w-32 text-blue-600" />
                </div>
              </div>
            </FadeInSection>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Systematic approach to managing environmental aspects and
                  impacts.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Globally recognized framework for environmental management.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Assess current environmental practices against ISO 14001
                    requirements.
                  </p>
                </div>
                <div className="text-center space-y-4">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Conduct internal audits to ensure system effectiveness.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    External audit and certification by accredited body.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Demonstrate your commitment to environmental responsibility with
                ISO 14001 certification. Join the global movement towards
