        ...
        <div className="container mx-auto px-4">
          <FadeInSection className="text-center space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              Person Company with complete legal compliance and documentation.
            </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-gray-600">
                Select the right structure for your business needs
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Perfect for solo entrepreneurs and individual businesses",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "For non-profit organizations promoting social welfare",
                  features: [
                ...
                },
                {
                  ...
                  description:
                    "Special type of company for agricultural and rural development activities",
                  features: [
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-gray-600">
                Simple 5-step process to get your company registered
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Provide company name, director details, and required documents",
                  icon: FileText,
                },
                {
                  step: "02",
                ...
                },
                {
                  ...
                  title: "Name Approval",
                  description:
                    "We check name availability and get approval from MCA",
                  icon: CheckCircle,
                },
                {
                  step: "04",
                  ...
                  description:
                    "Submit incorporation documents and get digital signatures",
                  icon: Shield,
                },
                {
                  step: "05",
                  ...
                  description:
                    "Receive Certificate of Incorporation and start business",
                  icon: Star,
                },
              ].map((step, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-blue-100">
                Unlock these benefits with company registration
              </p>
            </div>
