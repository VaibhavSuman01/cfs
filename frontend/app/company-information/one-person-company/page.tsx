            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Launch your dream venture as a single founder with the
                  benefits of a corporate structure. An OPC offers limited
                  liability and a separate legal identity, ideal for solo
                  business owners.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                An OPC combines the benefits of a sole proprietorship and a
                company, giving entrepreneurs a unique advantage.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Your personal assets are protected from business debts and
                  liabilities.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Complete control over the company and its operations without
                  any interference.
                </p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Easier to raise funds from venture capitalists, angel
                  investors, and banks.
                </p>
              </Card>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Select the package that best fits your OPC registration
                requirements
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Our efficient process ensures your OPC is registered in just a
                few simple steps.
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    We help you file an application for your unique company name
                    using the SPICE+ PART A form.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    We prepare and file all required documents, including
                    SPICE+, eMOA, and eAOA with digital signatures.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    The CRC processes your application and issues the
                    Certificate of Incorporation, PAN, TAN, and other
                    registrations.
                  </p>
                </div>
              </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Keep these documents handy for a hassle-free registration
                experience.
              </p>
            </div>
              ...
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>PAN Card is mandatory.</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>Consent of the nominee in Form INC-3.</span>
                  </li>
                </ul>
              </Card>
              <Card className="p-6">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Find answers to common questions about One Person Company
                registration.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                ...
                Register your One Person Company with us today and turn your
                vision into reality.
              </p>
