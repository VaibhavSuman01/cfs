    ...
    <div className="min-h-screen bg-white">
            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link href={`/dashboard/company-information?service=${encodeURIComponent('Public Limited Company')}`} passHref>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">What is a Public Limited Company?</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-semibold mb-2">Not a Private Company</h3>
                <p className="text-gray-600">By definition, it is a company that is not a private company and can invite the public to subscribe to its shares.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <Users className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Minimum Members</h3>
                <p className="text-gray-600">Requires a minimum of 7 shareholders to start, with no upper limit on the number of members.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <Shield className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">No Minimum Capital</h3>
                <p className="text-gray-600">As per the Companies Act, 2013, there is no minimum paid-up share capital requirement to form a Public Limited Company.</p>
              </Card>
            </div>
          </div>
        </section>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">Choose Your Public Limited Package</h2>
              <p className="text-lg text-gray-600">
                Select the package that best fits your public limited company registration requirements
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="text-4xl font-bold text-gray-900">₹15,999</div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={() => window.location.href = '/dashboard/company-information?service=Public+Limited+Company'} className="w-full bg-blue-600 hover:bg-blue-700">Choose Basic</Button>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-blue-400 hover:border-blue-600 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={() => window.location.href = '/dashboard/company-information?service=Public+Limited+Company'} className="w-full bg-blue-600 hover:bg-blue-700">Choose Standard</Button>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="text-4xl font-bold text-gray-900">₹30,999</div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={() => window.location.href = '/dashboard/company-information?service=Public+Limited+Company'} className="w-full bg-blue-600 hover:bg-blue-700">Choose Premium</Button>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">Streamlined Registration Process</h2>
              <p className="text-lg text-gray-600">
                We follow a structured and transparent process to get your Public Limited Company registered swiftly.
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-xl font-semibold">Apply for Company Name</h3>
                  <p className="text-gray-600">File an application for your business name via the SPICE+ PART A form. We help you choose a unique name that gets approved quickly.</p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <h3 className="text-xl font-semibold">Prepare & File Documents</h3>
                  <p className="text-gray-600">We prepare and file essential documents like SPICE+, eMOA, and eAOA, all attested with the digital signatures of directors and shareholders.</p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <h3 className="text-xl font-semibold">Processing & Incorporation</h3>
                  <p className="text-gray-600">The CRC processes the documents and upon approval, issues the Certificate of Incorporation along with PAN, TAN, and other mandatory registrations.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">Frequently Asked Questions</h2>
              <p className="text-lg text-gray-600">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {[
                {
                  question: "What is the minimum number of members for a Public Limited Company?",
                  answer: "A Public Limited Company must have a minimum of seven shareholders (members). There is no maximum limit on the number of shareholders."
                },
                {
                  question: "What is the minimum number of directors required?",
                  answer: "A minimum of three directors are required to form a Public Limited Company. A company can have up to 15 directors, which can be increased by passing a special resolution."
                },
                {
                  question: "Is a prospectus mandatory for all Public Limited Companies?",
                  answer: "A prospectus is a legal document that must be issued if the company intends to raise capital from the public. If not raising funds publicly, a 'statement in lieu of prospectus' must be filed with the ROC."
                },
                {
                  question: "What are the annual compliance requirements?",
                  answer: "Public Limited Companies have more stringent compliance requirements, including statutory audits, conducting at least four board meetings and one AGM annually, and filing various forms like MGT-7 and AOC-4 with the ROC."
                }
              ].map((faq, index) => (
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold">Ready to Go Public?</h2>
