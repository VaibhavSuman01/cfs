            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Establish your non-profit organization with the legal
                  structure of a company. A Section 8 Company is ideal for
                  promoting commerce, art, science, sports, education, research,
                  social welfare, religion, or charity.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                A Section 8 Company is registered for charitable or
                not-for-profit purposes. The profits generated must be used to
                promote its objects and cannot be distributed as dividends to
                its members.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Established for promoting commerce, art, science, sports,
              ...
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Intends to apply all its profits or other income in promoting
              ...
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">
                  Operates under a license from the Central Government and
                  enjoys several privileges and exemptions under company law.
                </p>
              </Card>
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Select the package that best fits your Section 8 company
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-3 text-left">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                      <span>80G & 12A Registration</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                We provide a seamless and transparent registration process for
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    We apply for the Digital Signature Certificate (DSC) and a
                    unique name for your company via the SPICE+ PART A form.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <p className="text-gray-600">
                    We prepare and file all necessary forms, including SPICE+,
                    eMoA, eAoA, and INC-15 declaration, with the MCA.
                  </p>
                </div>
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                  ...
                  <h3 className="text-xl font-semibold">
                    Get License & Incorporate
                  </h3>
                  <p className="text-gray-600">
                    The CRC processes the documents and issues the license and
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Gather these documents to ensure a smooth and quick registration
                process.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <span>Form DIR-2 (Consent to act as a director).</span>
                  </li>
                </ul>
              </Card>
              <Card className="p-6">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Here are some frequently asked questions about Section 8 Company
                registration.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Start your non-profit venture today with a Section 8 Company.
                Our experts are here to help you navigate the registration
