...
export default function DigitalSignaturePage() {
  const basePrice = getBasePrice("digital signature") ?? "As per request";
    ...
    <div className="min-h-screen bg-white">
            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link href={`/dashboard/other-registration-form?service=${encodeURIComponent('Digital Signature')}`} passHref>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">What is a Digital Signature Certificate?</h2>
              <p className="text-lg text-gray-600">
                The electronic equivalent of physical or paper certificates for secure online transactions
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">Prove your identity and authenticate documents digitally with high security.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <FileText className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Legal Validity</h3>
                <p className="text-gray-600">Legally recognized for e-filing, online transactions, and document signing.</p>
              </Card>
              <Card className="text-center p-6 border-2 border-transparent hover:border-blue-200 hover:shadow-xl transition-all">
                <Smartphone className="mx-auto h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Digital Convenience</h3>
                <p className="text-gray-600">Access government services and conduct business online from anywhere.</p>
              </Card>
            </div>
          </div>
        </section>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">DSC Application Process</h2>
              <p className="text-lg text-gray-600">
                Our streamlined process to get your Digital Signature Certificate
              </p>
            </div>
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-16 relative">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">Submit DSC application with required documents.</p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">Identity and document verification process.</p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">Digital certificate generation and encryption.</p>
                </div>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">Secure delivery of your DSC certificate.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold">Ready to Go Digital?</h2>
              <p className="text-xl text-blue-100 leading-relaxed">
                Secure your online presence and unlock the convenience of digital transactions. Get your Digital Signature Certificate today and step into the future of secure business.
              </p>
