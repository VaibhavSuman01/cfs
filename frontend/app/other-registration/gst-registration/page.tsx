            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-3 text-left">
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" /><span>GST Registration Application</span></li>
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" /><span>Basic Documentation Support</span></li>
                  ...
                  <Link href={`/contact?service=${encodeURIComponent('GST Registration - Basic')}`} passHref>
              ...
              <Card className="border-2 border-blue-400 hover:border-blue-600 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link href={`/contact?service=${encodeURIComponent('GST Registration - Standard')}`} passHref>
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link href={`/contact?service=${encodeURIComponent('GST Registration - Premium')}`} passHref>
