            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link href={`/dashboard/other-registration?service=${encodeURIComponent('GST Registration')}`} passHref>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link href={`/dashboard/other-registration?service=${encodeURIComponent('GST Registration - Basic')}`} passHref>
              ...
              <Card className="border-2 border-blue-400 hover:border-blue-600 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="text-4xl font-bold text-gray-900">₹3,499</div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link href={`/dashboard/other-registration?service=${encodeURIComponent('GST Registration - Standard')}`} passHref>
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Link href={`/dashboard/other-registration?service=${encodeURIComponent('GST Registration - Premium')}`} passHref>
