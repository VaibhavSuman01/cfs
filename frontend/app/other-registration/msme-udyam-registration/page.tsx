    ...
    <div className="min-h-screen bg-white">
            ...
            <FadeInSection className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-3 gap-4 pt-6">
                  ...
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    <div className="text-2xl font-bold text-blue-600">Government</div>
                    <div className="text-sm text-gray-600">Recognition</div>
                  </div>
                </div>

                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link href={`/dashboard/other-registration?service=${encodeURIComponent('MSME Udyam Registration')}`} passHref>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">What is MSME Registration?</h2>
      ...
      <FadeInSection>
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent">MSME Registration Process</h2>
              <p className="text-lg text-gray-600">
