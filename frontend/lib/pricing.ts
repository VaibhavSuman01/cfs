...
const PRICING_RAW: Record<string, ServicePricing> = {
  ...
  "trademark registration (for msme)": {
    ...
    tooltip:
      "Inclusive of government fees. Prices may vary based on complexity and industry standards",
  },
  "iso 9001:2015": {
  ...
  "gst filing": {
    ...
    tooltip:
      "Prices vary based on filing frequency, complexity, and industry standards",
  },
  "income tax filing": {
    basePrice: "₹1,499*",
    packages: { BASIC: "₹1,499*" },
  ...
  "project report": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on project complexity, scope, and industry standards",
  },
  "bank reconciliation": {
    basePrice: "As per request*",
  ...
  "dscr/cma report": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on report complexity, scope, and industry standards",
  },
  ...
  "epfo filing": {
    ...
    packages: { BASIC: "₹2,499*" },
    tooltip:
      "Prices vary based on filing complexity, employee count, and industry standards",
  },
  "esic registration": {
    basePrice: "₹2,499*",
    packages: { BASIC: "₹2,499*" },
  ...
  "fassai food license": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on license type, business size, and industry standards",
  },
  "iec registration": {
    basePrice: "₹2,499*",
    packages: { BASIC: "₹2,499*" },
  ...
  "industry license": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on industry type, business size, and regulatory requirements",
  },
  ...
  "ngo registration": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on NGO type, activities, and regulatory requirements",
  },
  "startup india registration": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on startup stage, documentation, and industry standards",
  },
  "digital signature": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on certificate type, validity period, and industry standards",
  },
  "copyright registration": {
    basePrice: "As per request*",
    tooltip:
      "Prices vary based on work type, complexity, and industry standards",
  },
