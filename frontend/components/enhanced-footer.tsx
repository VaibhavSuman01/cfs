        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Getting your business started with simple, swift and reasonably
              priced legal services, online. We are your trusted partner for
              business registrations, filings, and compliances.
            </p>
