...
import { downloadDocumentWithAuth } from "../../../utils/fileUtils";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                      ...
                      <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                        ...
                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                          <div>
                            ...
                            {form.incomeTaxLoginId || "Not provided"}
                          </div>
                          <div className="mt-1">
                            <span className="font-medium">Password:</span>{" "}
                            {form.incomeTaxLoginPassword
                              ? form.incomeTaxLoginPassword
                              : "Not provided"}
                          </div>
                        </dd>
                        ...
                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                          <div className="grid grid-cols-1 gap-2">
                            <div>
                              ...
                              {form.homeLoanSanctionDate || "Not provided"}
                            </div>
                            <div>
                              <span className="font-medium">Loan Amount:</span>{" "}
                              {form.homeLoanAmount || "Not provided"}
                            </div>
                            <div>
                              <span className="font-medium">
                                Current Due Amount:
                              </span>{" "}
                              {form.homeLoanCurrentDue || "Not provided"}
                            </div>
                            <div>
                              <span className="font-medium">
                                Total Interest:
                              </span>{" "}
                              {form.homeLoanTotalInterest || "Not provided"}
                            </div>
                          </div>
                        </dd>
                      </div>
            ...
            <div className="px-4 py-5 sm:px-6 border-t border-gray-200 bg-gray-50">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Files uploaded by the applicant. Other documents can be up to
                50MB in size.
              </p>
                ...
                {form.documents && form.documents.length > 0 ? (
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {form.documents.map((doc, index) => {
                      ...
                      const docTypeColor = isOtherDocument
                        ? "text-purple-500"
                        : "text-primary-500";

                      // Format file size
                      const fileSizeInMB = doc.fileSize
                          ...
                          <div className="flex items-start space-x-3">
                            <div
                              className={`flex-shrink-0 rounded-md bg-${
                                isOtherDocument ? "purple" : "primary"
                              }-100 p-2`}
                            >
                              <DocumentTextIcon
            ...
            <div className="px-4 py-5 sm:px-6 border-t border-gray-200 bg-gray-50">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Change the current status of this tax filing. Current status:{" "}
              ...
              <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className={`w-full inline-flex justify-center items-center px-4 py-2 border text-sm font-medium rounded-md shadow-sm ${
                        form.status === "Pending"
                          ? "border-yellow-300 text-yellow-700 bg-yellow-100 cursor-not-allowed"
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        Documents checked and verified
                      </p>
                    </div>
                  </div>
                  <div className="mt-4">
                    <button
                      ...
                      className={`w-full inline-flex justify-center items-center px-4 py-2 border text-sm font-medium rounded-md shadow-sm ${
                        form.status === "Reviewed"
                          ? "border-blue-300 text-blue-700 bg-blue-100 cursor-not-allowed"
                ...
                >
                  <div className="flex items-center">
                    <div
                      className={`flex-shrink-0 rounded-full p-1 ${
                        form.status === "Filed" ? "bg-green-100" : "bg-gray-100"
                      }`}
                    >
                      <CheckCircleIcon
                        className={`h-6 w-6 ${
